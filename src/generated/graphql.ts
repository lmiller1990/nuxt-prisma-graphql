...
export type LinkFragment = { readonly __typename?: 'Link', readonly id: number, readonly order: number, readonly text: string, readonly href: string };

export type LinksFragment = { readonly __typename?: 'User', readonly links: ReadonlyArray<{ readonly __typename?: 'Link', readonly id: number, readonly order: number, readonly text: string, readonly href: string }> };

export type AppQueryVariables = Exact<{ [key: string]: never; }>;


export type AppQuery = { readonly __typename?: 'Query', readonly viewer: { readonly __typename?: 'User', readonly id: number, readonly email: string, readonly links: ReadonlyArray<{ readonly __typename?: 'Link', readonly id: number, readonly order: number, readonly text: string, readonly href: string }> } | null | undefined };
